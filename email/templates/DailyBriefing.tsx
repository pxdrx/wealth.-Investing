...
// PNG bytes for the Dexter pixel-art mascot (64x64, generated by
// scripts/gen-dexter-png.mjs from the source SVG). Embedded as base64
// so the image renders pre-deploy and survives Gmail proxies that
// strip remote <img src=...> until proof-of-origin handshakes complete.
const DEXTER_PNG_B64 =
  '';

function MascotDexter({ size = 32 }: { size?: number }) {
  return (
    <Img
      src={`data:image/png;base64,${DEXTER_PNG_B64}`}
      alt="Dexter"
      width={size}
      height={size}
