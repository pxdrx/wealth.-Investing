...
const tiers: TierDef[] = [
  ...
  },
  {
    ...
    features: [
      "Tudo do Pro, mais:",
      "MetaTrader ao vivo — equity, posições e drawdown em tempo real, como um dashboard de mesa",
      "Análise Psicológica IA — seus padrões destrutivos expostos antes de custarem caro",
      "Dexter — 5 agentes IA dissecam seus trades como analistas de uma prop",
      "Coach Premium (300 msg) — um mentor que não te poupa, usando seus dados reais",
      "Alertas Inteligentes — te avisa antes de você repetir o mesmo erro",
      "Contas ilimitadas + PDF export",
    ],
  },
];
