  ...
  return (
    <section className="py-16 lg:py-24">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <h2 className="text-[28px] lg:text-[36px] font-semibold leading-tight tracking-tight text-foreground mb-3">
          Planos a partir de{" "}
          <span className="text-muted-foreground italic font-normal">R$0/mês.</span>
        </h2>
        <p className="text-[14px] text-muted-foreground max-w-xl mx-auto mb-10">
          ...
          {TIERS.map((t) => (
            <div
              ...
              className={
                ...
                (t.highlighted
                  ? "bg-zinc-900 dark:bg-zinc-950 text-white border-zinc-900 shadow-lg"
            ...
            >
              ...
              <div className="flex items-baseline gap-1 mb-2">
                <span className={"text-[22px] font-semibold " + (t.highlighted ? "text-white" : "text-foreground")}>
                  {t.price}
                </span>
                <span className={"text-[11px] " + (t.highlighted ? "text-zinc-400" : "text-muted-foreground")}>
                  {t.period}
                </span>
              </div>
              <p className={"text-[12px] leading-snug " + (t.highlighted ? "text-zinc-300" : "text-muted-foreground")}>
                {t.desc}
              </p>
            </div>
          ))}
